var ofmeet = (function(of)
{
    window.addEventListener("load", function()
    {
        ...
        chatButton.addEventListener("click", function (e)
        {
            ...
            chatFrame.style.display = "inline";
